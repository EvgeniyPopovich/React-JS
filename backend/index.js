...
app.post('/addproduct', async (req, res) => {
    ...
    const products = new Product({header, price, image})
    await products.save()
    res.json({
...
app.get('/products', async (req, res) => {
    ...
    /*const products = [
        ...
        { id: 2,header: 'Товар 2', price: 121 },
        { id: 3,header: 'Товар 3', price: 122 },
        { id: 4,header: 'Товар 4', price: 123 },
        { id: 5,header: 'Товар 5', price: 124 },
        { id: 6,header: 'Товар 6', price: 125 },
        { id: 7,header: 'Товар 7', price: 126 },
        { id: 8,header: 'Товар 8', price: 127 },
      ]*/
